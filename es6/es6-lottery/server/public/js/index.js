	...
	var Lottery = function (_mix) {
	  ...
	  _createClass(Lottery, [{
	    ...
	    value: function initEvent() {
	      ...
	      (0, _jquery2.default)('.dxjo').on('click', 'li', self.assitHandle.bind(self));
	...
	var Base = function () {
	  ...
	  _createClass(Base, [{
	    ...
	    value: function addCode() {
	      ...
	      if (count) {
	        self.addCodeItem($active.join(' '), self.cur_cur_play, self.play_list.get(self.cur_play).name, count);
	      }
	    }
	    ...
	    value: function getCount() {
	      ...
	      if (count === 0) {
	        ...
	        tpl = '\u60A8\u9009\u4E86 <b>' + count + '</b> \u6CE8\uFF0C\u5171 <b>' + count * 2 + '</b> \u5143 <em>\u82E5\u4E2D\u5956\uFF0C\u5956\u91D1:<strong class="red">' + range[0] + '</strong> \u5143,\u60A8\u5C06' + (win1 < 0 && win2 < 0 ? '亏损' : '盈利') + ' <strong class="' + (win1 >= 0 ? 'red' : 'green') + '">' + c1 + '</strong> \u81F3 <strong class="' + (win2 >= 0 ? 'red' : 'green') + '">' + c1 + '</strong>\u5143</em>';
	      }
...
/***/ (function(module, exports) {
	...
	var Calculate = function () {
	  ...
	  _createClass(Calculate, [{
	     ...
	     * @param  {[type]} play_name [description]
	     * @return {[type]}           [description]
	     */
